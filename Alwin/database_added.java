/* CarRentalFull.java
    ...
    - Database: **SQLite Local File Integration** (No Internet Needed)
    - FEATURE ADDED: Booking History for Users
*/
...
public class CarRentalFull {
    ...
    // ---------------- DataStore (SQLite Local File Integration) ----------------
    public static class DataStore {
        
        // ⚠️ SQLITE SETTINGS: Connects to a local file, requires no network.
        private static final String JDBC_URL = "jdbc:sqlite:carrental.db"; // Database file name
        ...
        static {
            try {
                ...
                // --- Ensure Tables Exist and Initialize Data ---
                ...
                System.err.println("Error connecting to SQLite DB: " + e.getMessage());
                e.printStackTrace();
                JOptionPane.showMessageDialog(null, "Database Initialization Failed! Check if the SQLite JAR file is in the folder.", "DB Error", JOptionPane.ERROR_MESSAGE);
                System.exit(1); 
            }
        }
    ...
    // ... (rest of the classes: MainFrame, LoginPanel, DashboardPanel, etc.)
    ...
    public static class DashboardPanel extends JPanel {
        ...
        public void setUser(User user){
            ...
            if(user.role.equals("user") || user.role.equals("seller")) {
        ...
        public void refreshAll(){
            ...
            sellerPanel.refresh(); 
            adminPanel.refresh();
            if(user!=null && (user.role.equals("user") || user.role.equals("seller"))) {
    ...
    public static class BookingHistoryPanel extends JPanel {
        ...
        public void refresh(){
            ...
            // Fetch bookings specific to the current user
